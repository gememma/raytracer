...
impl SimpleCamera {
    ...
    pub fn get_ray_pixel(&self, x: usize, y: usize) -> Ray {
        ...
        Ray::new(
            ...
            Vector::new(fx - 0.5, 0.5 - fy, self.fov).normalised(),
        )
    }
}

impl Camera for SimpleCamera {
    /// Given an [`Environment`], call [`env.raytrace()`][Environment::raytrace()] on each of the
    /// [`Ray`]s generated by [`get_ray_pixel()`][Self::get_ray_pixel()] and store the result in
    /// the [`FrameBuffer`].
